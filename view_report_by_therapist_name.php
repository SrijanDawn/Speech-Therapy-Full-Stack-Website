...
if (isset($_POST['therapist_name'])) {
    $therapist_name = $_POST['therapist_name'];

    // Prepare the SQL statement
    $sql = "SELECT * FROM therapist_reports WHERE therapist_name = ?";
    ...
    if ($result->num_rows > 0) {
        echo "<h2>Reports by Therapist: " . htmlspecialchars($therapist_name) . "</h2>";
        echo "<table border='1'>";
        echo "<tr>
                <th>ID</th>
                <th>Patient Name</th>
        ...
        echo "No reports found for the specified therapist.";
    }
...
<head>
    ...
    <title>View Reports by Therapist Name</title>
</head>
<style>
...
<body>
    <h1>Search Reports by Therapist Name</h1>
